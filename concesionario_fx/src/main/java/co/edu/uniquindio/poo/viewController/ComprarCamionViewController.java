...
public class ComprarCamionViewController {
    App app;
    @FXML
    ...
    @FXML
    private TextField txfTipoCamion;
    ...
    @FXML
    private CheckBox checkSiFrenosDeAire;
