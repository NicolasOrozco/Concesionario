...
public class ComprarPickUpViewController {
    App app;
    @FXML
    ...
    @FXML
    private CheckBox checkNo4x4;

    @FXML
    private TextField txfCapacidadCaja;
    ...
    @FXML
    private Label lblCapacidadCaja;
